...
STATION_DB = {
    ...
    "exits": {
        # ── 역삼동 (강남대로 동편) ──────────────────────────────────────────────
        "1번 출구":  {"장소": "특허청, 역삼세무서",      "door": "교대 1-1 / 역삼 10-4", "coord": [37.498047, 127.028740], "esc": True,  "bus": "광역 9404·9503"},
        "2번 출구":  {"장소": "테헤란로, 주민센터",      "door": "교대 2-3 / 역삼 9-2",  "coord": [37.49729,  127.02816 ], "esc": False, "bus": "간선 146·341"},
        "3번 출구":  {"장소": "강남역사거리, 역삼 방면", "door": "교대 2-4 / 역삼 9-1",  "coord": [37.496760, 127.028437], "esc": True,  "bus": "—"},
        "4번 출구":  {"장소": "뱅뱅사거리 (신분당선)",   "door": "교대 2-4 / 역삼 9-1",  "coord": [37.495458, 127.029075], "esc": True,  "bus": "—"},
        # ── 서초동 (강남대로 서편) ──────────────────────────────────────────────
        "5번 출구":  {"장소": "서초동 우성아파트",        "door": "교대 5-2 / 역삼 6-3",  "coord": [37.495291, 127.028571], "esc": True,  "bus": "M버스 6427"},
        "6번 출구":  {"장소": "강남역사거리, 서초 방면", "door": "교대 2-4 / 역삼 9-1",  "coord": [37.496484, 127.027990], "esc": True,  "bus": "—"},
        "7번 출구":  {"장소": "KDB산업은행",              "door": "교대 2-4 / 역삼 9-1",  "coord": [37.496484, 127.027994], "esc": True,  "bus": "—"},
        "8번 출구":  {"장소": "삼성전자 서초사옥",        "door": "교대 8-3 / 역삼 3-2",  "coord": [37.497513, 127.027184], "esc": True,  "bus": "순환 41"},
        ...
        # ── 테헤란로 북쪽 ───────────────────────────────────────────────────────
        "11번 출구": {"장소": "강남역 사거리",            "door": "교대 10-4 / 역삼 1-1", "coord": [37.498764, 127.027490], "esc": True,  "bus": "직행 1100·2000"},
